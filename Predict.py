...
def TestFunc():
    pd_id = "118622"  # 用户中心页可以查询到pd信息
    pd_key = "6M2/ETCHJPn6DRrRbtxnPSPhJ5GmsjTN"
    app_id = "318622"  # 开发者分成用的账号，在开发者中心可以查询到
    app_key = "pFMjNEQzbq2JW334cgpxqLNxRaWDda12"
    ...
    # 通过文件形式识别：
    file_name = "image/1573901281.1564028.jpg"
